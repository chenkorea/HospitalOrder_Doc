package com.boil.hospitalorder.hospitaldoctor.main.homepage.tagtools;
...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener
{
    ...
    public TagFlowLayout(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        isCancel= ta.getInt(R.styleable.TagFlowLayout_is_cancel, -1);
        ta.recycle();
...
//            lp.rightMargin = clp.rightMargin;
    ...
    public void doSelect(TagView child, int position, boolean isChange)
    {
        if (mAutoSelectEffect)
        {
            if (!child.isChecked())
