 ...
 * 
 */
public class FilterMenuChargeFragment extends BaseFragment implements OnDateSetListener{
    ...
    private SureonClick2 sureOnClickListener;
	...
	private void initData() {
		...
		if(context instanceof DangerValueDetailActivity) {
			sureOnClickListener = (DangerValueDetailActivity)getActivity();
		} 
		TypeVo vo = null;
...
//		showDateDialogHour();
		...
		LinearLayout3 = (LinearLayout) layout.findViewById(R.id.LinearLayout3);
	...
	private void setOnListener() {
		tv_cancel.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Activity context = getActivity();
				if(context instanceof DangerValueDetailActivity) {
					((DangerValueDetailActivity) getActivity()).toggleFilterMenu();
				} 
			}
		});
...
//				datePickerDialog.show();				
	...
	private void resetMenu() {
		mFlowLayout.doSelect((TagView)mFlowLayout.getChildAt(0), 0, false);
		mFlowLayout2.doSelect((TagView)mFlowLayout2.getChildAt(0), 0, true);
		categoryItemVo.setAdmTypeId(typeVos2.get(0).getTypeNo());
		categoryItemVo.setDepTypeId(typeVos1.get(0).getTypeNo());
	}
