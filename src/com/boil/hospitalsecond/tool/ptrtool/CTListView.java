package com.boil.hospitalsecond.tool.ptrtool;
...
public class CTListView extends ListView implements OnScrollListener {
	...
	private CTLoadMoreListener listenerLoadMore;
	...
	private RelativeLayout rel_more,rel_all;
	...
	public interface CTLoadMoreListener{
		void loadMoreClick();
	}
	...
	public void setListenerLoadMore(CTLoadMoreListener listenerLoadMore) {
	...
	public void initBottomView() {
		...
		if (footerView == null) {
			...
			rel_all = (RelativeLayout) footerView.findViewById(R.id.rel_all);
			rel_all.setOnClickListener(new OnClickListener() {
				
				@Override
				public void onClick(View v) {
					if(isLoadMore) {
						listenerLoadMore.loadMoreClick();
					}
				}
			});
		}
